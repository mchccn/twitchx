...
export default function Sidebar({ active }: { active: string }) {
    return (
        <aside
            className="sidebar transform -translate-x-full absolute md:static md:transform-none px-4 lg:px-0 py-3 w-60 flex-shrink-0 border-r border-gray-100 dark:border-gray-700 overflow-y-scroll"
